...
export default function Footer() {
    return (
        <footer className="w-full bg-white/30 backdrop-blur-sm border-t border-[#021334]/10 mt-auto">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
                <div className="flex flex-col md:flex-row justify-between gap-8">
                    ...
                    <div className="flex flex-col gap-4 md:w-1/3">
                        ...
                        <p className="text-sm text-[#021334]/70 max-w-xs">
                            Développeur full-stack passionné par la création d&apos;applications web modernes, responsives et accessibles.
                        </p>
                    </div>
                    
                    {/* Navigation */}
                    <div className="flex flex-col gap-4">
                        <h3 className="text-base font-semibold text-[#021334]">Navigation</h3>
                        <nav>
                    ...
                    {/* Réseaux sociaux */}
                    <div className="flex flex-col gap-4">
                        <h3 className="text-base font-semibold text-[#021334]">Me suivre</h3>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs md:text-sm text-[#021334]/60">
                        &copy; {new Date().getFullYear()} Paul Boisaubert-Baillion. Tous droits réservés.
                    </p>
                    <p className="text-xs md:text-sm text-[#021334]/60">
